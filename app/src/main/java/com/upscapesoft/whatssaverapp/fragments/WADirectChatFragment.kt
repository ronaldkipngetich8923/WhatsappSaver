...
class WADirectChatFragment : Fragment() {
    ...
    private fun openWhatsApp() {
        ...
        if (whatsappInstalledOrNot("com.whatsapp")) {
            ...
            try {
                ...
                Toast.makeText(requireActivity().applicationContext, "Please install WhatsApp", Toast.LENGTH_LONG).show()
            ...
            Toast.makeText(requireActivity().applicationContext, "WhatsApp not Installed", Toast.LENGTH_SHORT).show()
